# Spark Express Edition NoellesRoles
...
- You are **REQUIRED** to install **Spark Edition wathe** to run this mod. (https://github.com/Kricium/TrainMurderMystery/)
- Most of these codes are AI-generated/modified.
